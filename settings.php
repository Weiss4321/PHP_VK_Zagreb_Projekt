...
if(isset($_GET['save'])) {
	...
	if($save == 'personal_data') {
		...
		if($vorname == "" || $nachname == "") {
			$error_msg = "Molim ispuniti Ime i Prezime.";
		} else {
		...
		if($email != $email2) {
			$error_msg = "Upisane adrese se ne podudaraju.";
		} else if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
			$error_msg = "Molim upisati ispravnu mail adresu.";
		} else if(!password_verify($passwort, $user['passwort'])) {
			$error_msg = "Molim upisati korektnu zaporku.";
		} else {
			...
			$success_msg = "Mail adresa je uspješno spremljena.";
		}
		...
		if($passwortNeu != $passwortNeu2) {
			$error_msg = "Upisane zaporke se ne podudaraju.";
		} else if($passwortNeu == "") {
			$error_msg = "Zaporka ne smije biti prazna.";
		} else if(!password_verify($passwortAlt, $user['passwort'])) {
			$error_msg = "Molim upisati ispravnu zaporku.";
		} else {
			...
			$success_msg = "Zaporka je uspješno spremljena.";
		}
...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#data" aria-controls="home" role="tab" data-toggle="tab">Osobni podaci</a></li>
    <li role="presentation"><a href="#email" aria-controls="profile" role="tab" data-toggle="tab">E-Mail</a></li>
    <li role="presentation"><a href="#passwort" aria-controls="messages" role="tab" data-toggle="tab">Zaporka</a></li>
  </ul>
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="data">
    	...
    	<form action="?save=personal_data" method="post" class="form-horizontal">
    		<div class="form-group">
    			<label for="inputVorname" class="col-sm-2 control-label">Ime</label>
    			<div class="col-sm-10">
    		...
    		<div class="form-group">
    			<label for="inputNachname" class="col-sm-2 control-label">Prezime</label>
    			<div class="col-sm-10">
    ...
    <div role="tabpanel" class="tab-pane" id="email">
    	<br>
    	<p>Za izmjenu Vaše E-Mail adrese upišite zaporku i novu E-Mail adresu.</p>
    	<form action="?save=email" method="post" class="form-horizontal">
    		<div class="form-group">
    			<label for="inputPasswort" class="col-sm-2 control-label">Zaporka</label>
    			<div class="col-sm-10">
    		...
    		<div class="form-group">
    			<label for="inputEmail2" class="col-sm-2 control-label">E-Mail (ponoviti)</label>
    			<div class="col-sm-10">
    ...
    <div role="tabpanel" class="tab-pane" id="passwort">
    	<br>
    	<p>Za promjenu zaporke upišite aktualnu zaporku kao i novu zaporku.</p>
    	<form action="?save=passwort" method="post" class="form-horizontal">
    		<div class="form-group">
    			<label for="inputPasswort" class="col-sm-2 control-label">Stara zaporka</label>
    			<div class="col-sm-10">
    		...
    		<div class="form-group">
    			<label for="inputPasswortNeu" class="col-sm-2 control-label">Nova zaporka</label>
    			<div class="col-sm-10">
    		...
    		<div class="form-group">
    			<label for="inputPasswortNeu2" class="col-sm-2 control-label">Nova zaporka (ponoviti)</label>
    			<div class="col-sm-10">
