...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#email" aria-controls="profile" role="tab" data-toggle="tab">Pregled uplata</a></li>
    <li role="presentation"><a href="#passwort" aria-controls="messages" role="tab" data-toggle="tab">Izvještaj</a></li>
  </ul>
