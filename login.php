...
if(isset($_POST['email']) && isset($_POST['passwort'])) {
	...
	if ($user !== false && password_verify($passwort, $user['passwort'])) {
		...
		$error_msg =  "Neispravna zaporka ili mail adresa.<br><br>";
	}
...
?>
 <div class="container small-container-330 form-signin">
  <form action="login.php" method="post">
	<h2 class="form-signin-heading">Prijavite se mailom i lozinkom</h2>
...
?>
	...
	<div class="checkbox">
	  <label>
		<input type="checkbox" value="remember-me" name="angemeldet_bleiben" value="1" checked> Ostanite prijavljeni
	  </label>
	</div>
	<button class="btn btn-lg btn-primary btn-block" type="submit">Prijava</button>
	<br>
	<a href="passwortvergessen.php">Zaboravljena zaporka</a>
  </form>
